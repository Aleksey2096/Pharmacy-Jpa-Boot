...
import static by.academy.pharmacy2.entity.Constant.CLIENT_ORDERS;
import static by.academy.pharmacy2.entity.Constant.CLIENT_ORDERS_INDEX;
...
public class ClientOrderController {
    ...
    public String findPaginatedByUser(@PathVariable final int currentPage,
        ...
        model.addAttribute(SEARCH_VALUE, searchValue)
                ...
                .addAttribute(PAGINATION, orderDBServiceImpl.readPaginatedByUser(currentPage,
                        recordsPerPage, orderField, orderType, searchValue, userDTO));
        return CLIENT_ORDERS_INDEX;
    }
}
